...
- [Core Meta Prompts](#core-meta-prompts)
  ...
  - [Chain-of-Thought Trigger](#chainofthought-trigger)
...
- [Legal & Compliance (Non-Advice)](#legal--compliance-nonadvice)
- [Finance & Accounting (Non-Advice)](#finance--accounting-nonadvice)
...
- [Health & Wellness (Non-Medical Advice)](#health--wellness-nonmedical-advice)
...
- [Political & Policy Analysis (Non-Advocacy)](#political--policy-analysis-nonadvocacy)
...
Role: [expert role] Objective: [desired outcome] Context: [background information] Constraints: [limits, tone,
policies] Output Format: [desired structure] Verification: list assumptions and uncertainties.

### Prompt Design Assistant

You are an expert prompt engineer. Create [n] tailored prompts for [task/domain]. For each prompt include:
role, context, constraints, output requirements, and a checklist for evaluating the response.
...
Design an interactive lesson on [topic]. Incorporate multimedia elements, quizzes, discussions, and
...
### Rapid Prompt 66 — Summarize

Summarize [document/text] in [number] bullet points. Highlight key themes, statistics, and action items.

### Rapid Prompt 67 — Translate

Translate the following text to [language], preserving tone and nuance: [input text].

### Rapid Prompt 68 — Explain Concept

Explain [topic] to a beginner. Use analogies and simple language.

### Rapid Prompt 69 — Compare

Compare [option A] and [option B] across dimensions: [criteria]. Provide pros and cons and recommend
one.


### Rapid Prompt 70 — Generate Ideas

Generate [number] creative ideas for [problem/challenge], including unconventional approaches.

### Rapid Prompt 71 — Outline

Create an outline for a [report/article/presentation] on [topic]. Include main sections and supporting points.

### Rapid Prompt 72 — Rewrite for Audience

Rewrite the text for [audience persona] with an appropriate tone and reading level.

### Rapid Prompt 73 — Create Checklist

Make a checklist for [procedure]. List steps, required materials, and success criteria.

### Rapid Prompt 74 — Design Survey

Design a short survey to gather feedback on [subject]. Include multiple choice and open questions.

### Rapid Prompt 75 — Plan Event

Plan an event for [occasion/audience]. Determine budget, agenda, logistics, and promotional strategy.

### Rapid Prompt 76 — Diagnostic Questions

List diagnostic questions to identify the root cause of [issue/problem].

### Rapid Prompt 77 — Brainstorm Keywords

Brainstorm keywords and hashtags for promoting [topic] on social media.

### Rapid Prompt 78 — Code Snippet

Write a code snippet in [language] to [achieve task]. Include comments explaining each step.

### Rapid Prompt 79 — Storyboard

Create a storyboard for a [video/ad] about [message]. Describe scenes, dialogue, and visuals.

### Rapid Prompt 80 — Prepare Interview

Prepare an interview guide to hire a [position]. Include structured questions and evaluation criteria.


### Rapid Prompt 81 — Launch Checklist

Develop a launch checklist for [product]. Cover pre‑launch tasks, launch day actions, and post‑launch
monitoring.

### Rapid Prompt 82 — Write Press Release

Write a press release announcing [event/product]. Include headline, subheading, body, quotes, and contact
info.

### Rapid Prompt 83 — Assess Competency

Draft a rubric to assess competency in [skill]. Define proficiency levels and observable behaviors.

### Rapid Prompt 84 — Calculate Metric

Describe how to calculate [metric] and interpret the result. Provide an example scenario.

### Rapid Prompt 85 — Social Media Calendar

Create a 14‑day social media content calendar for [brand/campaign]. Specify platform, post type, and key
message for each day.

### Rapid Prompt 86 — Facilitate Brainstorm

Facilitate a brainstorming session on [topic]. Outline rules, prompts, and evaluation criteria for ideas.

### Rapid Prompt 87 — Argument Analysis

Analyze an argument about [topic]. Identify premises, conclusion, assumptions, and logical fallacies.

### Rapid Prompt 88 — Write Email Response

Compose a professional email response to [situation]. Clarify expectations, provide next steps, and maintain
a positive tone.

### Rapid Prompt 89 — Problem‑Solving Steps

Outline the steps to solve [problem]. Include data gathering, analysis, solution generation, and evaluation.

### Rapid Prompt 90 — Debate Preparation

Prepare talking points for a debate on [issue]. List supporting arguments, counterarguments, and evidence.


### Rapid Prompt 91 — SOP Template

Draft a standard operating procedure for [process]. Include purpose, scope, responsibilities, steps, and
KPIs.

### Rapid Prompt 92 — Marketing Persona

Create a marketing persona named [persona] representing [segment]. Describe demographics,
motivations, pain points, and preferred channels.

### Rapid Prompt 93 — Customer Journey Map

Outline a customer journey for [product/service] from awareness to advocacy. Highlight touchpoints,
emotions, and opportunities to improve.

### Rapid Prompt 94 — Localization Strategy

Propose a localization strategy for entering [country/region]. Address content adaptation, cultural nuances,
legal requirements, and marketing channels.

### Rapid Prompt 95 — Talk Show Outline

Outline the structure for a [type of show] featuring [guest/topic]. List segments, questions, and audience
interaction elements.

### Rapid Prompt 96 — Error Handling

Describe how to handle errors for [system/process]. Define error types, user messaging, logging, and
recovery strategies.

### Rapid Prompt 97 — Roadmap Plan

Create a roadmap for [project] over the next [time frame]. Include key milestones, deliverables, and
dependencies.

### Rapid Prompt 98 — Audience Feedback Form

Develop a feedback form for [event/product/service]. Include Likert scale questions and open comments.

### Rapid Prompt 99 — Task Prioritization

Prioritize tasks from [task list] using an importance/urgency matrix.

### Rapid Prompt 100 — Market Entry Analysis

Conduct a market entry analysis for [product] in [region]. Assess competition, customer needs, and
regulatory environment.


### Rapid Prompt 101 — Pricing Strategy

Formulate a pricing strategy for [product/service]. Consider cost structure, value perception, competitor
pricing, and demand elasticity.

### Rapid Prompt 102 — Outreach Message

Write a cold outreach message to [potential partner/investor]. Keep it concise, highlight mutual benefits,
and include a call to action.

### Rapid Prompt 103 — Explainer Video Script

Write a script for a 2‑minute explainer video about [topic]. Structure it into introduction, problem, solution,
benefits, and call to action.

### Rapid Prompt 104 — Newsletter Outline

Draft an outline for a monthly newsletter for [audience]. Include regular sections, themes, and engagement
features.

### Rapid Prompt 105 — Risk Assessment

Perform a qualitative risk assessment for [project]. Identify risks, assess impact and likelihood, and propose
mitigation strategies.

### Rapid Prompt 106 — Vendor Evaluation

Create criteria to evaluate vendors for [service/supply]. Include cost, quality, reliability, and alignment with
requirements.

### Rapid Prompt 107 — Brand Tagline

Brainstorm [number] tagline options for [brand/product]. Keep them catchy, concise, and aligned with
brand values.

### Rapid Prompt 108 — Community Guidelines

Draft community guidelines for [platform/group]. Emphasize respect, inclusivity, moderation policies, and
enforcement procedures.

### Rapid Prompt 109 — Meeting Agenda

Prepare an agenda for a meeting on [topic]. Include goals, agenda items, time allocation, and expected
outcomes.


### Rapid Prompt 110 — Write Case Study

Write a case study about [business/success story]. Include problem, solution, implementation, results, and
lessons learned.

### Rapid Prompt 111 — Evaluation Survey

Design an evaluation survey for [training/event]. Include questions to measure satisfaction, learning
outcomes, and suggestions.

### Rapid Prompt 112 — Transform Tone

Transform the tone of [input text] to [tone style] while preserving the meaning.

### Rapid Prompt 113 — Create Table

Create a table summarizing [information]. Use columns for [criteria] and rows for [items].

### Rapid Prompt 114 — Brand Story

Tell the brand story of [company]. Highlight origin, mission, challenges, and impact with a narrative arc.

### Rapid Prompt 115 — Goal Progress Report

Write a progress report on achieving [goal]. Include accomplishments, roadblocks, next steps, and metrics.

### Rapid Prompt 116 — Policy Summary

Summarize a policy document on [subject] into key points and implications.

### Rapid Prompt 117 — Compliance Report

Compile a compliance report for [industry/regulation]. Outline compliance status, gaps, and
recommendations.

### Rapid Prompt 118 — Team Charter

Develop a team charter for [team]. Include purpose, goals, roles, communication protocols, and success
criteria.

### Rapid Prompt 119 — Retrospective Guide

Write a guide for running a retrospective meeting. Suggest activities, timeboxing, and follow‑up actions.

### Rapid Prompt 120 — Data Collection Plan

Create a data collection plan for [study]. Define variables, instruments, timeline, and data quality checks.


### Rapid Prompt 121 — Annual Report Summary

Summarize the annual report of [organization]. Highlight financial performance, strategic initiatives, and
future outlook.

### Rapid Prompt 122 — Workflow Automation

Describe steps to automate [workflow/process] using [tool/platform]. Include triggers, actions, and
monitoring.

### Rapid Prompt 123 — Employee Recognition Program

Design an employee recognition program for [company]. Define award categories, criteria, nomination
process, and celebration methods.

### Rapid Prompt 124 — Brand Persona

Develop a brand persona that personifies [brand]. Describe characteristics, personality traits, values, and
communication style.

### Rapid Prompt 125 — Focus Group Script

Draft a script for moderating a focus group about [topic]. Include introduction, warm‑up questions, core
questions, and closing.

### Rapid Prompt 126 — Awareness Campaign Plan

Plan an awareness campaign for [cause/issue]. Define objectives, target audience, key messages, channels,
and measures of success.

### Rapid Prompt 127 — Cross‑Functional Alignment Plan

Design a plan to align cross‑functional teams on [initiative]. Outline communication routines, shared KPIs,
and conflict resolution mechanisms.

### Rapid Prompt 128 — Business Continuity Plan

Outline a business continuity plan for [organization]. Identify critical functions, backup strategies,
communication protocols, and recovery timelines.

### Rapid Prompt 129 — Rewards & Recognition Framework

Develop a rewards and recognition framework for [organization]. Include reward types, criteria, frequency,
and fairness considerations.


### Rapid Prompt 130 — Investor Outreach Plan

Create an investor outreach plan for [startup]. Identify investor profiles, messaging strategy, pitch
materials, and follow‑up actions.

### Rapid Prompt 131 — Summarize

Summarize [document/text] in [number] bullet points. Highlight key themes, statistics, and action items.

### Rapid Prompt 132 — Translate

Translate the following text to [language], preserving tone and nuance: [input text].

### Rapid Prompt 133 — Explain Concept

Explain [topic] to a beginner. Use analogies and simple language.

### Rapid Prompt 134 — Compare

Compare [option A] and [option B] across dimensions: [criteria]. Provide pros and cons and recommend
one.

### Rapid Prompt 135 — Generate Ideas

Generate [number] creative ideas for [problem/challenge], including unconventional approaches.

### Rapid Prompt 136 — Outline

Create an outline for a [report/article/presentation] on [topic]. Include main sections and supporting points.

### Rapid Prompt 137 — Rewrite for Audience

Rewrite the text for [audience persona] with an appropriate tone and reading level.

### Rapid Prompt 138 — Create Checklist

Make a checklist for [procedure]. List steps, required materials, and success criteria.

### Rapid Prompt 139 — Design Survey

Design a short survey to gather feedback on [subject]. Include multiple choice and open questions.

### Rapid Prompt 140 — Plan Event

Plan an event for [occasion/audience]. Determine budget, agenda, logistics, and promotional strategy.


### Rapid Prompt 141 — Diagnostic Questions

List diagnostic questions to identify the root cause of [issue/problem].

### Rapid Prompt 142 — Brainstorm Keywords

Brainstorm keywords and hashtags for promoting [topic] on social media.

### Rapid Prompt 143 — Code Snippet

Write a code snippet in [language] to [achieve task]. Include comments explaining each step.

### Rapid Prompt 144 — Storyboard

Create a storyboard for a [video/ad] about [message]. Describe scenes, dialogue, and visuals.

### Rapid Prompt 145 — Prepare Interview

Prepare an interview guide to hire a [position]. Include structured questions and evaluation criteria.

### Rapid Prompt 146 — Launch Checklist

Develop a launch checklist for [product]. Cover pre‑launch tasks, launch day actions, and post‑launch
monitoring.

### Rapid Prompt 147 — Write Press Release

Write a press release announcing [event/product]. Include headline, subheading, body, quotes, and contact
info.

### Rapid Prompt 148 — Assess Competency

Draft a rubric to assess competency in [skill]. Define proficiency levels and observable behaviors.

### Rapid Prompt 149 — Calculate Metric

Describe how to calculate [metric] and interpret the result. Provide an example scenario.

### Rapid Prompt 150 — Social Media Calendar

Create a 14‑day social media content calendar for [brand/campaign]. Specify platform, post type, and key
message for each day.

### Rapid Prompt 151 — Facilitate Brainstorm

Facilitate a brainstorming session on [topic]. Outline rules, prompts, and evaluation criteria for ideas.


### Rapid Prompt 152 — Argument Analysis

Analyze an argument about [topic]. Identify premises, conclusion, assumptions, and logical fallacies.

### Rapid Prompt 153 — Write Email Response

Compose a professional email response to [situation]. Clarify expectations, provide next steps, and maintain
a positive tone.

### Rapid Prompt 154 — Problem‑Solving Steps

Outline the steps to solve [problem]. Include data gathering, analysis, solution generation, and evaluation.

### Rapid Prompt 155 — Debate Preparation

Prepare talking points for a debate on [issue]. List supporting arguments, counterarguments, and evidence.

### Rapid Prompt 156 — SOP Template

Draft a standard operating procedure for [process]. Include purpose, scope, responsibilities, steps, and
KPIs.

### Rapid Prompt 157 — Marketing Persona

Create a marketing persona named [persona] representing [segment]. Describe demographics,
motivations, pain points, and preferred channels.

### Rapid Prompt 158 — Customer Journey Map

Outline a customer journey for [product/service] from awareness to advocacy. Highlight touchpoints,
emotions, and opportunities to improve.

### Rapid Prompt 159 — Localization Strategy

Propose a localization strategy for entering [country/region]. Address content adaptation, cultural nuances,
legal requirements, and marketing channels.

### Rapid Prompt 160 — Talk Show Outline

Outline the structure for a [type of show] featuring [guest/topic]. List segments, questions, and audience
interaction elements.

### Rapid Prompt 161 — Error Handling

Describe how to handle errors for [system/process]. Define error types, user messaging, logging, and
recovery strategies.


### Rapid Prompt 162 — Roadmap Plan

Create a roadmap for [project] over the next [time frame]. Include key milestones, deliverables, and
dependencies.

### Rapid Prompt 163 — Audience Feedback Form

Develop a feedback form for [event/product/service]. Include Likert scale questions and open comments.

### Rapid Prompt 164 — Task Prioritization

Prioritize tasks from [task list] using an importance/urgency matrix.

### Rapid Prompt 165 — Market Entry Analysis

Conduct a market entry analysis for [product] in [region]. Assess competition, customer needs, and
regulatory environment.

### Rapid Prompt 166 — Pricing Strategy

Formulate a pricing strategy for [product/service]. Consider cost structure, value perception, competitor
pricing, and demand elasticity.

### Rapid Prompt 167 — Outreach Message

Write a cold outreach message to [potential partner/investor]. Keep it concise, highlight mutual benefits,
and include a call to action.

### Rapid Prompt 168 — Explainer Video Script

Write a script for a 2‑minute explainer video about [topic]. Structure it into introduction, problem, solution,
benefits, and call to action.

### Rapid Prompt 169 — Newsletter Outline

Draft an outline for a monthly newsletter for [audience]. Include regular sections, themes, and engagement
features.

### Rapid Prompt 170 — Risk Assessment

Perform a qualitative risk assessment for [project]. Identify risks, assess impact and likelihood, and propose
mitigation strategies.

### Rapid Prompt 171 — Vendor Evaluation

Create criteria to evaluate vendors for [service/supply]. Include cost, quality, reliability, and alignment with
requirements.


### Rapid Prompt 172 — Brand Tagline

Brainstorm [number] tagline options for [brand/product]. Keep them catchy, concise, and aligned with
brand values.

### Rapid Prompt 173 — Community Guidelines

Draft community guidelines for [platform/group]. Emphasize respect, inclusivity, moderation policies, and
enforcement procedures.

### Rapid Prompt 174 — Meeting Agenda

Prepare an agenda for a meeting on [topic]. Include goals, agenda items, time allocation, and expected
outcomes.

### Rapid Prompt 175 — Write Case Study

Write a case study about [business/success story]. Include problem, solution, implementation, results, and
lessons learned.

### Rapid Prompt 176 — Evaluation Survey

Design an evaluation survey for [training/event]. Include questions to measure satisfaction, learning
outcomes, and suggestions.

### Rapid Prompt 177 — Transform Tone

Transform the tone of [input text] to [tone style] while preserving the meaning.

### Rapid Prompt 178 — Create Table

Create a table summarizing [information]. Use columns for [criteria] and rows for [items].

### Rapid Prompt 179 — Brand Story

Tell the brand story of [company]. Highlight origin, mission, challenges, and impact with a narrative arc.

### Rapid Prompt 180 — Goal Progress Report

Write a progress report on achieving [goal]. Include accomplishments, roadblocks, next steps, and metrics.

### Rapid Prompt 181 — Policy Summary

Summarize a policy document on [subject] into key points and implications.


### Rapid Prompt 182 — Compliance Report

Compile a compliance report for [industry/regulation]. Outline compliance status, gaps, and
recommendations.

### Rapid Prompt 183 — Team Charter

Develop a team charter for [team]. Include purpose, goals, roles, communication protocols, and success
criteria.

### Rapid Prompt 184 — Retrospective Guide

Write a guide for running a retrospective meeting. Suggest activities, timeboxing, and follow‑up actions.

### Rapid Prompt 185 — Data Collection Plan

Create a data collection plan for [study]. Define variables, instruments, timeline, and data quality checks.

### Rapid Prompt 186 — Annual Report Summary

Summarize the annual report of [organization]. Highlight financial performance, strategic initiatives, and
future outlook.

### Rapid Prompt 187 — Workflow Automation

Describe steps to automate [workflow/process] using [tool/platform]. Include triggers, actions, and
monitoring.

### Rapid Prompt 188 — Employee Recognition Program

Design an employee recognition program for [company]. Define award categories, criteria, nomination
process, and celebration methods.

### Rapid Prompt 189 — Brand Persona

Develop a brand persona that personifies [brand]. Describe characteristics, personality traits, values, and
communication style.

### Rapid Prompt 190 — Focus Group Script

Draft a script for moderating a focus group about [topic]. Include introduction, warm‑up questions, core
questions, and closing.

### Rapid Prompt 191 — Awareness Campaign Plan

Plan an awareness campaign for [cause/issue]. Define objectives, target audience, key messages, channels,
and measures of success.


### Rapid Prompt 192 — Cross‑Functional Alignment Plan

Design a plan to align cross‑functional teams on [initiative]. Outline communication routines, shared KPIs,
and conflict resolution mechanisms.

### Rapid Prompt 193 — Business Continuity Plan

Outline a business continuity plan for [organization]. Identify critical functions, backup strategies,
communication protocols, and recovery timelines.

### Rapid Prompt 194 — Rewards & Recognition Framework

Develop a rewards and recognition framework for [organization]. Include reward types, criteria, frequency,
and fairness considerations.

### Rapid Prompt 195 — Investor Outreach Plan

Create an investor outreach plan for [startup]. Identify investor profiles, messaging strategy, pitch
materials, and follow‑up actions.

### Rapid Prompt 196 — Summarize

Summarize [document/text] in [number] bullet points. Highlight key themes, statistics, and action items.

### Rapid Prompt 197 — Translate

Translate the following text to [language], preserving tone and nuance: [input text].

### Rapid Prompt 198 — Explain Concept

Explain [topic] to a beginner. Use analogies and simple language.

### Rapid Prompt 199 — Compare

Compare [option A] and [option B] across dimensions: [criteria]. Provide pros and cons and recommend
one.

### Rapid Prompt 200 — Generate Ideas

Generate [number] creative ideas for [problem/challenge], including unconventional approaches.

### Rapid Prompt 201 — Outline

Create an outline for a [report/article/presentation] on [topic]. Include main sections and supporting points.


### Rapid Prompt 202 — Rewrite for Audience

Rewrite the text for [audience persona] with an appropriate tone and reading level.

### Rapid Prompt 203 — Create Checklist

Make a checklist for [procedure]. List steps, required materials, and success criteria.

### Rapid Prompt 204 — Design Survey

Design a short survey to gather feedback on [subject]. Include multiple choice and open questions.

### Rapid Prompt 205 — Plan Event

Plan an event for [occasion/audience]. Determine budget, agenda, logistics, and promotional strategy.

### Rapid Prompt 206 — Diagnostic Questions

List diagnostic questions to identify the root cause of [issue/problem].

### Rapid Prompt 207 — Brainstorm Keywords

Brainstorm keywords and hashtags for promoting [topic] on social media.

### Rapid Prompt 208 — Code Snippet

Write a code snippet in [language] to [achieve task]. Include comments explaining each step.

### Rapid Prompt 209 — Storyboard

Create a storyboard for a [video/ad] about [message]. Describe scenes, dialogue, and visuals.

### Rapid Prompt 210 — Prepare Interview

Prepare an interview guide to hire a [position]. Include structured questions and evaluation criteria.

### Rapid Prompt 211 — Launch Checklist

Develop a launch checklist for [product]. Cover pre‑launch tasks, launch day actions, and post‑launch
monitoring.

### Rapid Prompt 212 — Write Press Release

Write a press release announcing [event/product]. Include headline, subheading, body, quotes, and contact
info.


### Rapid Prompt 213 — Assess Competency

Draft a rubric to assess competency in [skill]. Define proficiency levels and observable behaviors.

### Rapid Prompt 214 — Calculate Metric

Describe how to calculate [metric] and interpret the result. Provide an example scenario.

### Rapid Prompt 215 — Social Media Calendar

Create a 14‑day social media content calendar for [brand/campaign]. Specify platform, post type, and key
message for each day.

### Rapid Prompt 216 — Facilitate Brainstorm

Facilitate a brainstorming session on [topic]. Outline rules, prompts, and evaluation criteria for ideas.

### Rapid Prompt 217 — Argument Analysis

Analyze an argument about [topic]. Identify premises, conclusion, assumptions, and logical fallacies.

### Rapid Prompt 218 — Write Email Response

Compose a professional email response to [situation]. Clarify expectations, provide next steps, and maintain
a positive tone.

### Rapid Prompt 219 — Problem‑Solving Steps

Outline the steps to solve [problem]. Include data gathering, analysis, solution generation, and evaluation.

### Rapid Prompt 220 — Debate Preparation

Prepare talking points for a debate on [issue]. List supporting arguments, counterarguments, and evidence.

### Rapid Prompt 221 — SOP Template

Draft a standard operating procedure for [process]. Include purpose, scope, responsibilities, steps, and
KPIs.

### Rapid Prompt 222 — Marketing Persona

Create a marketing persona named [persona] representing [segment]. Describe demographics,
motivations, pain points, and preferred channels.


### Rapid Prompt 223 — Customer Journey Map

Outline a customer journey for [product/service] from awareness to advocacy. Highlight touchpoints,
emotions, and opportunities to improve.

### Rapid Prompt 224 — Localization Strategy

Propose a localization strategy for entering [country/region]. Address content adaptation, cultural nuances,
legal requirements, and marketing channels.

### Rapid Prompt 225 — Talk Show Outline

Outline the structure for a [type of show] featuring [guest/topic]. List segments, questions, and audience
interaction elements.

### Rapid Prompt 226 — Error Handling

Describe how to handle errors for [system/process]. Define error types, user messaging, logging, and
recovery strategies.

### Rapid Prompt 227 — Roadmap Plan

Create a roadmap for [project] over the next [time frame]. Include key milestones, deliverables, and
dependencies.

### Rapid Prompt 228 — Audience Feedback Form

Develop a feedback form for [event/product/service]. Include Likert scale questions and open comments.

### Rapid Prompt 229 — Task Prioritization

Prioritize tasks from [task list] using an importance/urgency matrix.

### Rapid Prompt 230 — Market Entry Analysis

Conduct a market entry analysis for [product] in [region]. Assess competition, customer needs, and
regulatory environment.

### Rapid Prompt 231 — Pricing Strategy

Formulate a pricing strategy for [product/service]. Consider cost structure, value perception, competitor
pricing, and demand elasticity.

### Rapid Prompt 232 — Outreach Message

Write a cold outreach message to [potential partner/investor]. Keep it concise, highlight mutual benefits,
and include a call to action.


### Rapid Prompt 233 — Explainer Video Script

Write a script for a 2‑minute explainer video about [topic]. Structure it into introduction, problem, solution,
benefits, and call to action.

### Rapid Prompt 234 — Newsletter Outline

Draft an outline for a monthly newsletter for [audience]. Include regular sections, themes, and engagement
features.

### Rapid Prompt 235 — Risk Assessment

Perform a qualitative risk assessment for [project]. Identify risks, assess impact and likelihood, and propose
mitigation strategies.

### Rapid Prompt 236 — Vendor Evaluation

Create criteria to evaluate vendors for [service/supply]. Include cost, quality, reliability, and alignment with
requirements.

### Rapid Prompt 237 — Brand Tagline

Brainstorm [number] tagline options for [brand/product]. Keep them catchy, concise, and aligned with
brand values.

### Rapid Prompt 238 — Community Guidelines

Draft community guidelines for [platform/group]. Emphasize respect, inclusivity, moderation policies, and
enforcement procedures.

### Rapid Prompt 239 — Meeting Agenda

Prepare an agenda for a meeting on [topic]. Include goals, agenda items, time allocation, and expected
outcomes.

### Rapid Prompt 240 — Write Case Study

Write a case study about [business/success story]. Include problem, solution, implementation, results, and
lessons learned.

### Rapid Prompt 241 — Evaluation Survey

Design an evaluation survey for [training/event]. Include questions to measure satisfaction, learning
outcomes, and suggestions.


### Rapid Prompt 242 — Transform Tone

Transform the tone of [input text] to [tone style] while preserving the meaning.

### Rapid Prompt 243 — Create Table

Create a table summarizing [information]. Use columns for [criteria] and rows for [items].

### Rapid Prompt 244 — Brand Story

Tell the brand story of [company]. Highlight origin, mission, challenges, and impact with a narrative arc.

### Rapid Prompt 245 — Goal Progress Report

Write a progress report on achieving [goal]. Include accomplishments, roadblocks, next steps, and metrics.

### Rapid Prompt 246 — Policy Summary

Summarize a policy document on [subject] into key points and implications.

### Rapid Prompt 247 — Compliance Report

Compile a compliance report for [industry/regulation]. Outline compliance status, gaps, and
recommendations.

### Rapid Prompt 248 — Team Charter

Develop a team charter for [team]. Include purpose, goals, roles, communication protocols, and success
criteria.

### Rapid Prompt 249 — Retrospective Guide

Write a guide for running a retrospective meeting. Suggest activities, timeboxing, and follow‑up actions.

### Rapid Prompt 250 — Data Collection Plan

Create a data collection plan for [study]. Define variables, instruments, timeline, and data quality checks.

### Rapid Prompt 251 — Annual Report Summary

Summarize the annual report of [organization]. Highlight financial performance, strategic initiatives, and
future outlook.

### Rapid Prompt 252 — Workflow Automation

Describe steps to automate [workflow/process] using [tool/platform]. Include triggers, actions, and
monitoring.


### Rapid Prompt 253 — Employee Recognition Program

Design an employee recognition program for [company]. Define award categories, criteria, nomination
process, and celebration methods.

### Rapid Prompt 254 — Brand Persona

Develop a brand persona that personifies [brand]. Describe characteristics, personality traits, values, and
communication style.

### Rapid Prompt 255 — Focus Group Script

Draft a script for moderating a focus group about [topic]. Include introduction, warm‑up questions, core
questions, and closing.

### Rapid Prompt 256 — Awareness Campaign Plan

Plan an awareness campaign for [cause/issue]. Define objectives, target audience, key messages, channels,
and measures of success.

### Rapid Prompt 257 — Cross‑Functional Alignment Plan

Design a plan to align cross‑functional teams on [initiative]. Outline communication routines, shared KPIs,
and conflict resolution mechanisms.

### Rapid Prompt 258 — Business Continuity Plan

Outline a business continuity plan for [organization]. Identify critical functions, backup strategies,
communication protocols, and recovery timelines.

### Rapid Prompt 259 — Rewards & Recognition Framework

Develop a rewards and recognition framework for [organization]. Include reward types, criteria, frequency,
and fairness considerations.

### Rapid Prompt 260 — Investor Outreach Plan

Create an investor outreach plan for [startup]. Identify investor profiles, messaging strategy, pitch
materials, and follow‑up actions.

### Rapid Prompt 261 — Summarize

Summarize [document/text] in [number] bullet points. Highlight key themes, statistics, and action items.

### Rapid Prompt 262 — Translate

Translate the following text to [language], preserving tone and nuance: [input text].


### Rapid Prompt 263 — Explain Concept

Explain [topic] to a beginner. Use analogies and simple language.

### Rapid Prompt 264 — Compare

Compare [option A] and [option B] across dimensions: [criteria]. Provide pros and cons and recommend
one.

### Rapid Prompt 265 — Generate Ideas

Generate [number] creative ideas for [problem/challenge], including unconventional approaches.

### Rapid Prompt 266 — Outline

Create an outline for a [report/article/presentation] on [topic]. Include main sections and supporting points.

### Rapid Prompt 267 — Rewrite for Audience

Rewrite the text for [audience persona] with an appropriate tone and reading level.

### Rapid Prompt 268 — Create Checklist

Make a checklist for [procedure]. List steps, required materials, and success criteria.

### Rapid Prompt 269 — Design Survey

Design a short survey to gather feedback on [subject]. Include multiple choice and open questions.

### Rapid Prompt 270 — Plan Event

Plan an event for [occasion/audience]. Determine budget, agenda, logistics, and promotional strategy.

### Rapid Prompt 271 — Diagnostic Questions

List diagnostic questions to identify the root cause of [issue/problem].

### Rapid Prompt 272 — Brainstorm Keywords

Brainstorm keywords and hashtags for promoting [topic] on social media.

### Rapid Prompt 273 — Code Snippet

Write a code snippet in [language] to [achieve task]. Include comments explaining each step.


### Rapid Prompt 274 — Storyboard

Create a storyboard for a [video/ad] about [message]. Describe scenes, dialogue, and visuals.

### Rapid Prompt 275 — Prepare Interview

Prepare an interview guide to hire a [position]. Include structured questions and evaluation criteria.

### Rapid Prompt 276 — Launch Checklist

Develop a launch checklist for [product]. Cover pre‑launch tasks, launch day actions, and post‑launch
monitoring.

### Rapid Prompt 277 — Write Press Release

Write a press release announcing [event/product]. Include headline, subheading, body, quotes, and contact
info.

### Rapid Prompt 278 — Assess Competency

Draft a rubric to assess competency in [skill]. Define proficiency levels and observable behaviors.

### Rapid Prompt 279 — Calculate Metric

Describe how to calculate [metric] and interpret the result. Provide an example scenario.

### Rapid Prompt 280 — Social Media Calendar

Create a 14‑day social media content calendar for [brand/campaign]. Specify platform, post type, and key
message for each day.

### Rapid Prompt 281 — Facilitate Brainstorm

Facilitate a brainstorming session on [topic]. Outline rules, prompts, and evaluation criteria for ideas.

### Rapid Prompt 282 — Argument Analysis

Analyze an argument about [topic]. Identify premises, conclusion, assumptions, and logical fallacies.

### Rapid Prompt 283 — Write Email Response

Compose a professional email response to [situation]. Clarify expectations, provide next steps, and maintain
a positive tone.

### Rapid Prompt 284 — Problem‑Solving Steps

Outline the steps to solve [problem]. Include data gathering, analysis, solution generation, and evaluation.


### Rapid Prompt 285 — Debate Preparation

Prepare talking points for a debate on [issue]. List supporting arguments, counterarguments, and evidence.

### Rapid Prompt 286 — SOP Template

Draft a standard operating procedure for [process]. Include purpose, scope, responsibilities, steps, and
KPIs.

### Rapid Prompt 287 — Marketing Persona

Create a marketing persona named [persona] representing [segment]. Describe demographics,
motivations, pain points, and preferred channels.

### Rapid Prompt 288 — Customer Journey Map

Outline a customer journey for [product/service] from awareness to advocacy. Highlight touchpoints,
emotions, and opportunities to improve.

### Rapid Prompt 289 — Localization Strategy

Propose a localization strategy for entering [country/region]. Address content adaptation, cultural nuances,
legal requirements, and marketing channels.

### Rapid Prompt 290 — Talk Show Outline

Outline the structure for a [type of show] featuring [guest/topic]. List segments, questions, and audience
interaction elements.

### Rapid Prompt 291 — Error Handling

Describe how to handle errors for [system/process]. Define error types, user messaging, logging, and
recovery strategies.

### Rapid Prompt 292 — Roadmap Plan

Create a roadmap for [project] over the next [time frame]. Include key milestones, deliverables, and
dependencies.

### Rapid Prompt 293 — Audience Feedback Form

Develop a feedback form for [event/product/service]. Include Likert scale questions and open comments.

### Rapid Prompt 294 — Task Prioritization

Prioritize tasks from [task list] using an importance/urgency matrix.


### Rapid Prompt 295 — Market Entry Analysis

Conduct a market entry analysis for [product] in [region]. Assess competition, customer needs, and
regulatory environment.

### Rapid Prompt 296 — Pricing Strategy

Formulate a pricing strategy for [product/service]. Consider cost structure, value perception, competitor
pricing, and demand elasticity.

### Rapid Prompt 297 — Outreach Message

Write a cold outreach message to [potential partner/investor]. Keep it concise, highlight mutual benefits,
and include a call to action.

### Rapid Prompt 298 — Explainer Video Script

Write a script for a 2‑minute explainer video about [topic]. Structure it into introduction, problem, solution,
benefits, and call to action.

### Rapid Prompt 299 — Newsletter Outline

Draft an outline for a monthly newsletter for [audience]. Include regular sections, themes, and engagement
features.

### Rapid Prompt 300 — Risk Assessment

Perform a qualitative risk assessment for [project]. Identify risks, assess impact and likelihood, and propose
mitigation strategies.

### Rapid Prompt 301 — Vendor Evaluation

Create criteria to evaluate vendors for [service/supply]. Include cost, quality, reliability, and alignment with
requirements.

### Rapid Prompt 302 — Brand Tagline

Brainstorm [number] tagline options for [brand/product]. Keep them catchy, concise, and aligned with
brand values.

### Rapid Prompt 303 — Community Guidelines

Draft community guidelines for [platform/group]. Emphasize respect, inclusivity, moderation policies, and
enforcement procedures.


### Rapid Prompt 304 — Meeting Agenda

Prepare an agenda for a meeting on [topic]. Include goals, agenda items, time allocation, and expected
outcomes.

### Rapid Prompt 305 — Write Case Study

Write a case study about [business/success story]. Include problem, solution, implementation, results, and
lessons learned.

### Rapid Prompt 306 — Evaluation Survey

Design an evaluation survey for [training/event]. Include questions to measure satisfaction, learning
outcomes, and suggestions.

### Rapid Prompt 307 — Transform Tone

Transform the tone of [input text] to [tone style] while preserving the meaning.

### Rapid Prompt 308 — Create Table

Create a table summarizing [information]. Use columns for [criteria] and rows for [items].

### Rapid Prompt 309 — Brand Story

Tell the brand story of [company]. Highlight origin, mission, challenges, and impact with a narrative arc.

### Rapid Prompt 310 — Goal Progress Report

Write a progress report on achieving [goal]. Include accomplishments, roadblocks, next steps, and metrics.

### Rapid Prompt 311 — Policy Summary

Summarize a policy document on [subject] into key points and implications.

### Rapid Prompt 312 — Compliance Report

Compile a compliance report for [industry/regulation]. Outline compliance status, gaps, and
recommendations.

### Rapid Prompt 313 — Team Charter

Develop a team charter for [team]. Include purpose, goals, roles, communication protocols, and success
criteria.


### Rapid Prompt 314 — Retrospective Guide

Write a guide for running a retrospective meeting. Suggest activities, timeboxing, and follow‑up actions.

### Rapid Prompt 315 — Data Collection Plan

Create a data collection plan for [study]. Define variables, instruments, timeline, and data quality checks.

### Rapid Prompt 316 — Annual Report Summary

Summarize the annual report of [organization]. Highlight financial performance, strategic initiatives, and
future outlook.

### Rapid Prompt 317 — Workflow Automation

Describe steps to automate [workflow/process] using [tool/platform]. Include triggers, actions, and
monitoring.

### Rapid Prompt 318 — Employee Recognition Program

Design an employee recognition program for [company]. Define award categories, criteria, nomination
process, and celebration methods.

### Rapid Prompt 319 — Brand Persona

Develop a brand persona that personifies [brand]. Describe characteristics, personality traits, values, and
communication style.

### Rapid Prompt 320 — Focus Group Script

Draft a script for moderating a focus group about [topic]. Include introduction, warm‑up questions, core
questions, and closing.

### Rapid Prompt 321 — Awareness Campaign Plan

Plan an awareness campaign for [cause/issue]. Define objectives, target audience, key messages, channels,
and measures of success.

### Rapid Prompt 322 — Cross‑Functional Alignment Plan

Design a plan to align cross‑functional teams on [initiative]. Outline communication routines, shared KPIs,
and conflict resolution mechanisms.

### Rapid Prompt 323 — Business Continuity Plan

Outline a business continuity plan for [organization]. Identify critical functions, backup strategies,
communication protocols, and recovery timelines.


### Rapid Prompt 324 — Rewards & Recognition Framework

Develop a rewards and recognition framework for [organization]. Include reward types, criteria, frequency,
and fairness considerations.

### Rapid Prompt 325 — Investor Outreach Plan

Create an investor outreach plan for [startup]. Identify investor profiles, messaging strategy, pitch
materials, and follow‑up actions.

### Rapid Prompt 326 — Summarize

Summarize [document/text] in [number] bullet points. Highlight key themes, statistics, and action items.

### Rapid Prompt 327 — Translate

Translate the following text to [language], preserving tone and nuance: [input text].

### Rapid Prompt 328 — Explain Concept

Explain [topic] to a beginner. Use analogies and simple language.

### Rapid Prompt 329 — Compare

Compare [option A] and [option B] across dimensions: [criteria]. Provide pros and cons and recommend
one.

### Rapid Prompt 330 — Generate Ideas

Generate [number] creative ideas for [problem/challenge], including unconventional approaches.

### Rapid Prompt 331 — Outline

Create an outline for a [report/article/presentation] on [topic]. Include main sections and supporting points.

### Rapid Prompt 332 — Rewrite for Audience

Rewrite the text for [audience persona] with an appropriate tone and reading level.

### Rapid Prompt 333 — Create Checklist

Make a checklist for [procedure]. List steps, required materials, and success criteria.

### Rapid Prompt 334 — Design Survey

Design a short survey to gather feedback on [subject]. Include multiple choice and open questions.


### Rapid Prompt 335 — Plan Event

Plan an event for [occasion/audience]. Determine budget, agenda, logistics, and promotional strategy.

### Rapid Prompt 336 — Diagnostic Questions

List diagnostic questions to identify the root cause of [issue/problem].

### Rapid Prompt 337 — Brainstorm Keywords

Brainstorm keywords and hashtags for promoting [topic] on social media.

### Rapid Prompt 338 — Code Snippet

Write a code snippet in [language] to [achieve task]. Include comments explaining each step.

### Rapid Prompt 339 — Storyboard

Create a storyboard for a [video/ad] about [message]. Describe scenes, dialogue, and visuals.

### Rapid Prompt 340 — Prepare Interview

Prepare an interview guide to hire a [position]. Include structured questions and evaluation criteria.

### Rapid Prompt 341 — Launch Checklist

Develop a launch checklist for [product]. Cover pre‑launch tasks, launch day actions, and post‑launch
monitoring.

### Rapid Prompt 342 — Write Press Release

Write a press release announcing [event/product]. Include headline, subheading, body, quotes, and contact
info.

### Rapid Prompt 343 — Assess Competency

Draft a rubric to assess competency in [skill]. Define proficiency levels and observable behaviors.

### Rapid Prompt 344 — Calculate Metric

Describe how to calculate [metric] and interpret the result. Provide an example scenario.

### Rapid Prompt 345 — Social Media Calendar

Create a 14‑day social media content calendar for [brand/campaign]. Specify platform, post type, and key
message for each day.


### Rapid Prompt 346 — Facilitate Brainstorm

Facilitate a brainstorming session on [topic]. Outline rules, prompts, and evaluation criteria for ideas.

### Rapid Prompt 347 — Argument Analysis

Analyze an argument about [topic]. Identify premises, conclusion, assumptions, and logical fallacies.

### Rapid Prompt 348 — Write Email Response

Compose a professional email response to [situation]. Clarify expectations, provide next steps, and maintain
a positive tone.

### Rapid Prompt 349 — Problem‑Solving Steps

Outline the steps to solve [problem]. Include data gathering, analysis, solution generation, and evaluation.

### Rapid Prompt 350 — Debate Preparation

Prepare talking points for a debate on [issue]. List supporting arguments, counterarguments, and evidence.

### Rapid Prompt 351 — SOP Template

Draft a standard operating procedure for [process]. Include purpose, scope, responsibilities, steps, and
KPIs.

### Rapid Prompt 352 — Marketing Persona

Create a marketing persona named [persona] representing [segment]. Describe demographics,
motivations, pain points, and preferred channels.

### Rapid Prompt 353 — Customer Journey Map

Outline a customer journey for [product/service] from awareness to advocacy. Highlight touchpoints,
emotions, and opportunities to improve.

### Rapid Prompt 354 — Localization Strategy

Propose a localization strategy for entering [country/region]. Address content adaptation, cultural nuances,
legal requirements, and marketing channels.

### Rapid Prompt 355 — Talk Show Outline

Outline the structure for a [type of show] featuring [guest/topic]. List segments, questions, and audience
interaction elements.


### Rapid Prompt 356 — Error Handling

Describe how to handle errors for [system/process]. Define error types, user messaging, logging, and
recovery strategies.

### Rapid Prompt 357 — Roadmap Plan

Create a roadmap for [project] over the next [time frame]. Include key milestones, deliverables, and
dependencies.

### Rapid Prompt 358 — Audience Feedback Form

Develop a feedback form for [event/product/service]. Include Likert scale questions and open comments.

### Rapid Prompt 359 — Task Prioritization

Prioritize tasks from [task list] using an importance/urgency matrix.

### Rapid Prompt 360 — Market Entry Analysis

Conduct a market entry analysis for [product] in [region]. Assess competition, customer needs, and
regulatory environment.

### Rapid Prompt 361 — Pricing Strategy

Formulate a pricing strategy for [product/service]. Consider cost structure, value perception, competitor
pricing, and demand elasticity.

### Rapid Prompt 362 — Outreach Message

Write a cold outreach message to [potential partner/investor]. Keep it concise, highlight mutual benefits,
and include a call to action.

### Rapid Prompt 363 — Explainer Video Script

Write a script for a 2‑minute explainer video about [topic]. Structure it into introduction, problem, solution,
benefits, and call to action.

### Rapid Prompt 364 — Newsletter Outline

Draft an outline for a monthly newsletter for [audience]. Include regular sections, themes, and engagement
features.

### Rapid Prompt 365 — Risk Assessment

Perform a qualitative risk assessment for [project]. Identify risks, assess impact and likelihood, and propose
mitigation strategies.


### Rapid Prompt 366 — Vendor Evaluation

Create criteria to evaluate vendors for [service/supply]. Include cost, quality, reliability, and alignment with
requirements.

### Rapid Prompt 367 — Brand Tagline

Brainstorm [number] tagline options for [brand/product]. Keep them catchy, concise, and aligned with
brand values.

### Rapid Prompt 368 — Community Guidelines

Draft community guidelines for [platform/group]. Emphasize respect, inclusivity, moderation policies, and
enforcement procedures.

### Rapid Prompt 369 — Meeting Agenda

Prepare an agenda for a meeting on [topic]. Include goals, agenda items, time allocation, and expected
outcomes.

### Rapid Prompt 370 — Write Case Study

Write a case study about [business/success story]. Include problem, solution, implementation, results, and
lessons learned.

### Rapid Prompt 371 — Evaluation Survey

Design an evaluation survey for [training/event]. Include questions to measure satisfaction, learning
outcomes, and suggestions.

### Rapid Prompt 372 — Transform Tone

Transform the tone of [input text] to [tone style] while preserving the meaning.

### Rapid Prompt 373 — Create Table

Create a table summarizing [information]. Use columns for [criteria] and rows for [items].

### Rapid Prompt 374 — Brand Story

Tell the brand story of [company]. Highlight origin, mission, challenges, and impact with a narrative arc.

### Rapid Prompt 375 — Goal Progress Report

Write a progress report on achieving [goal]. Include accomplishments, roadblocks, next steps, and metrics.


### Rapid Prompt 376 — Policy Summary

Summarize a policy document on [subject] into key points and implications.

### Rapid Prompt 377 — Compliance Report

Compile a compliance report for [industry/regulation]. Outline compliance status, gaps, and
recommendations.

### Rapid Prompt 378 — Team Charter

Develop a team charter for [team]. Include purpose, goals, roles, communication protocols, and success
criteria.

### Rapid Prompt 379 — Retrospective Guide

Write a guide for running a retrospective meeting. Suggest activities, timeboxing, and follow‑up actions.

### Rapid Prompt 380 — Data Collection Plan

Create a data collection plan for [study]. Define variables, instruments, timeline, and data quality checks.

### Rapid Prompt 381 — Annual Report Summary

Summarize the annual report of [organization]. Highlight financial performance, strategic initiatives, and
future outlook.

### Rapid Prompt 382 — Workflow Automation

Describe steps to automate [workflow/process] using [tool/platform]. Include triggers, actions, and
monitoring.

### Rapid Prompt 383 — Employee Recognition Program

Design an employee recognition program for [company]. Define award categories, criteria, nomination
process, and celebration methods.

### Rapid Prompt 384 — Brand Persona

Develop a brand persona that personifies [brand]. Describe characteristics, personality traits, values, and
communication style.

### Rapid Prompt 385 — Focus Group Script

Draft a script for moderating a focus group about [topic]. Include introduction, warm‑up questions, core
questions, and closing.


### Rapid Prompt 386 — Awareness Campaign Plan

Plan an awareness campaign for [cause/issue]. Define objectives, target audience, key messages, channels,
and measures of success.

### Rapid Prompt 387 — Cross‑Functional Alignment Plan

Design a plan to align cross‑functional teams on [initiative]. Outline communication routines, shared KPIs,
and conflict resolution mechanisms.

### Rapid Prompt 388 — Business Continuity Plan

Outline a business continuity plan for [organization]. Identify critical functions, backup strategies,
communication protocols, and recovery timelines.

### Rapid Prompt 389 — Rewards & Recognition Framework

Develop a rewards and recognition framework for [organization]. Include reward types, criteria, frequency,
and fairness considerations.

### Rapid Prompt 390 — Investor Outreach Plan

Create an investor outreach plan for [startup]. Identify investor profiles, messaging strategy, pitch
materials, and follow‑up actions.

### Rapid Prompt 391 — Summarize

Summarize [document/text] in [number] bullet points. Highlight key themes, statistics, and action items.

### Rapid Prompt 392 — Translate

Translate the following text to [language], preserving tone and nuance: [input text].

### Rapid Prompt 393 — Explain Concept

Explain [topic] to a beginner. Use analogies and simple language.

### Rapid Prompt 394 — Compare

Compare [option A] and [option B] across dimensions: [criteria]. Provide pros and cons and recommend
one.

### Rapid Prompt 395 — Generate Ideas

Generate [number] creative ideas for [problem/challenge], including unconventional approaches.


### Rapid Prompt 396 — Outline

Create an outline for a [report/article/presentation] on [topic]. Include main sections and supporting points.

### Rapid Prompt 397 — Rewrite for Audience

Rewrite the text for [audience persona] with an appropriate tone and reading level.

### Rapid Prompt 398 — Create Checklist

Make a checklist for [procedure]. List steps, required materials, and success criteria.

### Rapid Prompt 399 — Design Survey

Design a short survey to gather feedback on [subject]. Include multiple choice and open questions.

### Rapid Prompt 400 — Plan Event

Plan an event for [occasion/audience]. Determine budget, agenda, logistics, and promotional strategy.

### Rapid Prompt 401 — Diagnostic Questions

List diagnostic questions to identify the root cause of [issue/problem].

### Rapid Prompt 402 — Brainstorm Keywords

Brainstorm keywords and hashtags for promoting [topic] on social media.

### Rapid Prompt 403 — Code Snippet

Write a code snippet in [language] to [achieve task]. Include comments explaining each step.

### Rapid Prompt 404 — Storyboard

Create a storyboard for a [video/ad] about [message]. Describe scenes, dialogue, and visuals.

### Rapid Prompt 405 — Prepare Interview

Prepare an interview guide to hire a [position]. Include structured questions and evaluation criteria.

### Rapid Prompt 406 — Launch Checklist

Develop a launch checklist for [product]. Cover pre‑launch tasks, launch day actions, and post‑launch
monitoring.


### Rapid Prompt 407 — Write Press Release

Write a press release announcing [event/product]. Include headline, subheading, body, quotes, and contact
info.

### Rapid Prompt 408 — Assess Competency

Draft a rubric to assess competency in [skill]. Define proficiency levels and observable behaviors.

### Rapid Prompt 409 — Calculate Metric

Describe how to calculate [metric] and interpret the result. Provide an example scenario.

### Rapid Prompt 410 — Social Media Calendar

Create a 14‑day social media content calendar for [brand/campaign]. Specify platform, post type, and key
message for each day.

### Rapid Prompt 411 — Facilitate Brainstorm

Facilitate a brainstorming session on [topic]. Outline rules, prompts, and evaluation criteria for ideas.

### Rapid Prompt 412 — Argument Analysis

Analyze an argument about [topic]. Identify premises, conclusion, assumptions, and logical fallacies.

### Rapid Prompt 413 — Write Email Response

Compose a professional email response to [situation]. Clarify expectations, provide next steps, and maintain
a positive tone.

### Rapid Prompt 414 — Problem‑Solving Steps

Outline the steps to solve [problem]. Include data gathering, analysis, solution generation, and evaluation.

### Rapid Prompt 415 — Debate Preparation

Prepare talking points for a debate on [issue]. List supporting arguments, counterarguments, and evidence.

### Rapid Prompt 416 — SOP Template

Draft a standard operating procedure for [process]. Include purpose, scope, responsibilities, steps, and
KPIs.


### Rapid Prompt 417 — Marketing Persona

Create a marketing persona named [persona] representing [segment]. Describe demographics,
motivations, pain points, and preferred channels.

### Rapid Prompt 418 — Customer Journey Map

Outline a customer journey for [product/service] from awareness to advocacy. Highlight touchpoints,
emotions, and opportunities to improve.

### Rapid Prompt 419 — Localization Strategy

Propose a localization strategy for entering [country/region]. Address content adaptation, cultural nuances,
legal requirements, and marketing channels.

### Rapid Prompt 420 — Talk Show Outline

Outline the structure for a [type of show] featuring [guest/topic]. List segments, questions, and audience
interaction elements.

### Rapid Prompt 421 — Error Handling

Describe how to handle errors for [system/process]. Define error types, user messaging, logging, and
recovery strategies.

### Rapid Prompt 422 — Roadmap Plan

Create a roadmap for [project] over the next [time frame]. Include key milestones, deliverables, and
dependencies.

### Rapid Prompt 423 — Audience Feedback Form

Develop a feedback form for [event/product/service]. Include Likert scale questions and open comments.

### Rapid Prompt 424 — Task Prioritization

Prioritize tasks from [task list] using an importance/urgency matrix.

### Rapid Prompt 425 — Market Entry Analysis

Conduct a market entry analysis for [product] in [region]. Assess competition, customer needs, and
regulatory environment.

### Rapid Prompt 426 — Pricing Strategy

Formulate a pricing strategy for [product/service]. Consider cost structure, value perception, competitor
pricing, and demand elasticity.


### Rapid Prompt 427 — Outreach Message

Write a cold outreach message to [potential partner/investor]. Keep it concise, highlight mutual benefits,
and include a call to action.

### Rapid Prompt 428 — Explainer Video Script

Write a script for a 2‑minute explainer video about [topic]. Structure it into introduction, problem, solution,
benefits, and call to action.

### Rapid Prompt 429 — Newsletter Outline

Draft an outline for a monthly newsletter for [audience]. Include regular sections, themes, and engagement
features.

### Rapid Prompt 430 — Risk Assessment

Perform a qualitative risk assessment for [project]. Identify risks, assess impact and likelihood, and propose
mitigation strategies.

### Rapid Prompt 431 — Vendor Evaluation

Create criteria to evaluate vendors for [service/supply]. Include cost, quality, reliability, and alignment with
requirements.

### Rapid Prompt 432 — Brand Tagline

Brainstorm [number] tagline options for [brand/product]. Keep them catchy, concise, and aligned with
brand values.

### Rapid Prompt 433 — Community Guidelines

Draft community guidelines for [platform/group]. Emphasize respect, inclusivity, moderation policies, and
enforcement procedures.

### Rapid Prompt 434 — Meeting Agenda

Prepare an agenda for a meeting on [topic]. Include goals, agenda items, time allocation, and expected
outcomes.

### Rapid Prompt 435 — Write Case Study

Write a case study about [business/success story]. Include problem, solution, implementation, results, and
lessons learned.


### Rapid Prompt 436 — Evaluation Survey

Design an evaluation survey for [training/event]. Include questions to measure satisfaction, learning
outcomes, and suggestions.

### Rapid Prompt 437 — Transform Tone

Transform the tone of [input text] to [tone style] while preserving the meaning.

### Rapid Prompt 438 — Create Table

Create a table summarizing [information]. Use columns for [criteria] and rows for [items].

### Rapid Prompt 439 — Brand Story

Tell the brand story of [company]. Highlight origin, mission, challenges, and impact with a narrative arc.

### Rapid Prompt 440 — Goal Progress Report

Write a progress report on achieving [goal]. Include accomplishments, roadblocks, next steps, and metrics.

### Rapid Prompt 441 — Policy Summary

Summarize a policy document on [subject] into key points and implications.

### Rapid Prompt 442 — Compliance Report

Compile a compliance report for [industry/regulation]. Outline compliance status, gaps, and
recommendations.

### Rapid Prompt 443 — Team Charter

Develop a team charter for [team]. Include purpose, goals, roles, communication protocols, and success
criteria.

### Rapid Prompt 444 — Retrospective Guide

Write a guide for running a retrospective meeting. Suggest activities, timeboxing, and follow‑up actions.

### Rapid Prompt 445 — Data Collection Plan

Create a data collection plan for [study]. Define variables, instruments, timeline, and data quality checks.

### Rapid Prompt 446 — Annual Report Summary

Summarize the annual report of [organization]. Highlight financial performance, strategic initiatives, and
future outlook.


### Rapid Prompt 447 — Workflow Automation

Describe steps to automate [workflow/process] using [tool/platform]. Include triggers, actions, and
monitoring.

### Rapid Prompt 448 — Employee Recognition Program

Design an employee recognition program for [company]. Define award categories, criteria, nomination
process, and celebration methods.

### Rapid Prompt 449 — Brand Persona

Develop a brand persona that personifies [brand]. Describe characteristics, personality traits, values, and
communication style.

### Rapid Prompt 450 — Focus Group Script

Draft a script for moderating a focus group about [topic]. Include introduction, warm‑up questions, core
questions, and closing.

### Rapid Prompt 451 — Awareness Campaign Plan

Plan an awareness campaign for [cause/issue]. Define objectives, target audience, key messages, channels,
and measures of success.

### Rapid Prompt 452 — Cross‑Functional Alignment Plan

Design a plan to align cross‑functional teams on [initiative]. Outline communication routines, shared KPIs,
and conflict resolution mechanisms.

### Rapid Prompt 453 — Business Continuity Plan

Outline a business continuity plan for [organization]. Identify critical functions, backup strategies,
communication protocols, and recovery timelines.

### Rapid Prompt 454 — Rewards & Recognition Framework

Develop a rewards and recognition framework for [organization]. Include reward types, criteria, frequency,
and fairness considerations.

### Rapid Prompt 455 — Investor Outreach Plan

Create an investor outreach plan for [startup]. Identify investor profiles, messaging strategy, pitch
materials, and follow‑up actions.


### Rapid Prompt 456 — Summarize

Summarize [document/text] in [number] bullet points. Highlight key themes, statistics, and action items.

### Rapid Prompt 457 — Translate

Translate the following text to [language], preserving tone and nuance: [input text].

### Rapid Prompt 458 — Explain Concept

Explain [topic] to a beginner. Use analogies and simple language.

### Rapid Prompt 459 — Compare

Compare [option A] and [option B] across dimensions: [criteria]. Provide pros and cons and recommend
one.

### Rapid Prompt 460 — Generate Ideas

Generate [number] creative ideas for [problem/challenge], including unconventional approaches.

### Rapid Prompt 461 — Outline

Create an outline for a [report/article/presentation] on [topic]. Include main sections and supporting points.

### Rapid Prompt 462 — Rewrite for Audience

Rewrite the text for [audience persona] with an appropriate tone and reading level.

### Rapid Prompt 463 — Create Checklist

Make a checklist for [procedure]. List steps, required materials, and success criteria.

### Rapid Prompt 464 — Design Survey

Design a short survey to gather feedback on [subject]. Include multiple choice and open questions.

### Rapid Prompt 465 — Plan Event

Plan an event for [occasion/audience]. Determine budget, agenda, logistics, and promotional strategy.

### Rapid Prompt 466 — Diagnostic Questions

List diagnostic questions to identify the root cause of [issue/problem].


### Rapid Prompt 467 — Brainstorm Keywords

Brainstorm keywords and hashtags for promoting [topic] on social media.

### Rapid Prompt 468 — Code Snippet

Write a code snippet in [language] to [achieve task]. Include comments explaining each step.

### Rapid Prompt 469 — Storyboard

Create a storyboard for a [video/ad] about [message]. Describe scenes, dialogue, and visuals.

### Rapid Prompt 470 — Prepare Interview

Prepare an interview guide to hire a [position]. Include structured questions and evaluation criteria.

### Rapid Prompt 471 — Launch Checklist

Develop a launch checklist for [product]. Cover pre‑launch tasks, launch day actions, and post‑launch
monitoring.

### Rapid Prompt 472 — Write Press Release

Write a press release announcing [event/product]. Include headline, subheading, body, quotes, and contact
info.

### Rapid Prompt 473 — Assess Competency

Draft a rubric to assess competency in [skill]. Define proficiency levels and observable behaviors.

### Rapid Prompt 474 — Calculate Metric

Describe how to calculate [metric] and interpret the result. Provide an example scenario.

### Rapid Prompt 475 — Social Media Calendar

Create a 14‑day social media content calendar for [brand/campaign]. Specify platform, post type, and key
message for each day.

### Rapid Prompt 476 — Facilitate Brainstorm

Facilitate a brainstorming session on [topic]. Outline rules, prompts, and evaluation criteria for ideas.

### Rapid Prompt 477 — Argument Analysis

Analyze an argument about [topic]. Identify premises, conclusion, assumptions, and logical fallacies.


### Rapid Prompt 478 — Write Email Response

Compose a professional email response to [situation]. Clarify expectations, provide next steps, and maintain
a positive tone.

### Rapid Prompt 479 — Problem‑Solving Steps

Outline the steps to solve [problem]. Include data gathering, analysis, solution generation, and evaluation.

### Rapid Prompt 480 — Debate Preparation

Prepare talking points for a debate on [issue]. List supporting arguments, counterarguments, and evidence.

### Rapid Prompt 481 — SOP Template

Draft a standard operating procedure for [process]. Include purpose, scope, responsibilities, steps, and
KPIs.

### Rapid Prompt 482 — Marketing Persona

Create a marketing persona named [persona] representing [segment]. Describe demographics,
motivations, pain points, and preferred channels.

### Rapid Prompt 483 — Customer Journey Map

Outline a customer journey for [product/service] from awareness to advocacy. Highlight touchpoints,
emotions, and opportunities to improve.

### Rapid Prompt 484 — Localization Strategy

Propose a localization strategy for entering [country/region]. Address content adaptation, cultural nuances,
legal requirements, and marketing channels.

### Rapid Prompt 485 — Talk Show Outline

Outline the structure for a [type of show] featuring [guest/topic]. List segments, questions, and audience
interaction elements.

### Rapid Prompt 486 — Error Handling

Describe how to handle errors for [system/process]. Define error types, user messaging, logging, and
recovery strategies.

### Rapid Prompt 487 — Roadmap Plan

Create a roadmap for [project] over the next [time frame]. Include key milestones, deliverables, and
dependencies.


### Rapid Prompt 488 — Audience Feedback Form

Develop a feedback form for [event/product/service]. Include Likert scale questions and open comments.

### Rapid Prompt 489 — Task Prioritization

Prioritize tasks from [task list] using an importance/urgency matrix.

### Rapid Prompt 490 — Market Entry Analysis

Conduct a market entry analysis for [product] in [region]. Assess competition, customer needs, and
regulatory environment.

### Rapid Prompt 491 — Pricing Strategy

Formulate a pricing strategy for [product/service]. Consider cost structure, value perception, competitor
pricing, and demand elasticity.

### Rapid Prompt 492 — Outreach Message

Write a cold outreach message to [potential partner/investor]. Keep it concise, highlight mutual benefits,
and include a call to action.

### Rapid Prompt 493 — Explainer Video Script

Write a script for a 2‑minute explainer video about [topic]. Structure it into introduction, problem, solution,
benefits, and call to action.

### Rapid Prompt 494 — Newsletter Outline

Draft an outline for a monthly newsletter for [audience]. Include regular sections, themes, and engagement
features.

### Rapid Prompt 495 — Risk Assessment

Perform a qualitative risk assessment for [project]. Identify risks, assess impact and likelihood, and propose
mitigation strategies.

### Rapid Prompt 496 — Vendor Evaluation

Create criteria to evaluate vendors for [service/supply]. Include cost, quality, reliability, and alignment with
requirements.

### Rapid Prompt 497 — Brand Tagline

Brainstorm [number] tagline options for [brand/product]. Keep them catchy, concise, and aligned with
brand values.


### Rapid Prompt 498 — Community Guidelines

Draft community guidelines for [platform/group]. Emphasize respect, inclusivity, moderation policies, and
enforcement procedures.

### Rapid Prompt 499 — Meeting Agenda

Prepare an agenda for a meeting on [topic]. Include goals, agenda items, time allocation, and expected
outcomes.

### Rapid Prompt 500 — Write Case Study
